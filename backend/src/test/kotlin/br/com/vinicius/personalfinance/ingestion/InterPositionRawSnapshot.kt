...
private fun StringBuilder.appendSection(section: InterPositionRawSection) {
    when (section) {
        ...
        is BrazilianEquityRawSection -> appendEquitySection("BRAZILIAN_EQUITY", section)
        is InternationalEquityRawSection -> appendEquitySection("INTERNATIONAL_EQUITY", section)

        is FixedIncomeRawSection -> {
            appendLine(
...
private fun StringBuilder.appendEquitySection(
    type: String,
